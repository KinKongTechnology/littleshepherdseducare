...
DocumentReference? get currentUserReference =>
    loggedIn ? StudentSchemaRecord.collection.doc(currentUser!.uid) : null;

StudentSchemaRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : StudentSchemaRecord.getDocument(
                  StudentSchemaRecord.collection.doc(uid))
              .handleError((_) {}),
    )
