                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintText: 'Short description of your comment..',
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color: FlutterFlowTheme.of(context).primaryText,
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await ParentCommentRecord.collection
                            .doc()
                            .set(createParentCommentRecordData(
                              parentName: _model.textController1.text,
                              studentName: _model.textController2.text,
                              comment: _model.textController3.text,
                              imageUpload: _model.uploadedFileUrl,
                            ));
                      },
                      text: 'Submit Comment',
                      icon: Icon(
